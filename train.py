...
class CurriculumCallback(BaseCallback):
    def __init__(self, env, eval_freq=50000, verbose=1):
        ...
        self.env = env  # now this is RobotDanceEnv, not DummyVecEnv
...
if __name__ == "__main__":
    SEED = 42
    MUSIC_PATH = "C:\\Users\\Taha Momin\\Desktop\\DANCE\\dance-until-dark-329026.mp3"  # Replace with your music file
    ...
    curriculum_cb = CurriculumCallback(vec_env.envs[0])
